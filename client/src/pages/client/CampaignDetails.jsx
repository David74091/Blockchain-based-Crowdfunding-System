    ...
    <div className="container mx-auto">
      ...
      <div className="w-full flex md:flex-row flex-col mt-10 gap-[30px]">
        ...
        <div className="flex md:w-[150px] w-full flex-wrap justify-between gap-[30px]">
          ...
          <CountBox
            title={`需求金額 ${state.target}`}
            value={state.amountCollected}
          />
          <CountBox title="總捐贈人數" value={donators.length} />
        </div>
      </div>
      ...
      <div className="mt-[60px] flex lg:flex-row flex-col gap-5">
        ...
        <div className="flex-1">
          <div className="mt-[20px] flex flex-col p-4 bg-[#F0F0F0] rounded-[10px]">
            ...
            <div className="mt-[30px]">
              <input
                ...
                placeholder="ETH 0.1"
                step="0.01"
                className="w-full py-[10px] sm:px-[20px] px-[15px] outline-none border-[1px] border-[#3a3a43] bg-transparent font-epilogue text-[18px] leading-[30px] placeholder:text-[#4b5264] rounded-[10px] mb-[20px]"
                value={amount}
