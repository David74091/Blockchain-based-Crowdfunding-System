...
import { SendTokensInput } from '@metaplex-foundation/js/dist/types/plugins/tokenModule';
...
export declare class NftClient {
    ...
    create(input: CreateNftInput, options?: OperationOptions): Promise<import("@metaplex-foundation/js/dist/types/plugins/nftModule/operations").CreateNftOutput>;
    ...
    send(input: PartialKeys<SendTokensInput, 'amount'>, options?: OperationOptions): Promise<import("@metaplex-foundation/js/dist/types/plugins/tokenModule").SendTokensOutput>;
}
