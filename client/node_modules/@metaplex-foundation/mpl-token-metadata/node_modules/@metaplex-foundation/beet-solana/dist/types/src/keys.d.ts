 ...
 */
export declare type KeysExports = keyof typeof import('@metaplex-foundation/mpl-token-metadata/node_modules/@metaplex-foundation/beet-solana/dist/types/src/keys');
/**
 * @category TypeDefinition
 */
