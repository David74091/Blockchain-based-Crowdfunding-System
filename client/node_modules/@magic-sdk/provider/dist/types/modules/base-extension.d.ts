import { createJsonRpcRequestPayload, standardizeJsonRpcRequestPayload } from '@magic-sdk/provider/dist/types/core/json-rpc';
import { BaseModule } from '@magic-sdk/provider/dist/types/modules/base-module';
import { SDKBase, MagicSDKAdditionalConfiguration, MagicSDKExtensionsOption } from '@magic-sdk/provider/dist/types/core/sdk';
import { MagicExtensionError, MagicExtensionWarning } from '@magic-sdk/provider/dist/types/core/sdk-exceptions';
import { createPromiEvent, encodeJSON, decodeJSON, storage, isPromiEvent } from '@magic-sdk/provider/dist/types/util';
