...
class StackService extends node_1.NodeService {
    ...
    import(vaultId, fileTxId, parentId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.setActionRef(constants_1.actionRefs.STACK_CREATE);
            this.setFunction(constants_1.functions.NODE_CREATE);
            const { file, resourceHash, resourceUrl } = yield this.fileService.import(fileTxId);
    ...
    */
    uploadRevision(stackId, file, progressHook) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.setVaultContextFromNodeId(stackId, this.objectType);
    ...
    getVersion(stackId, index) {
        return __awaiter(this, void 0, void 0, function* () {
            const stack = new node_2.Stack(yield this.api.getNode(stackId, constants_1.objectType.STACK, this.vaultId), null);
            let version;
            if (index) {
