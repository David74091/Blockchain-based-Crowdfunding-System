...
class FileService extends service_1.Service {
    ...
    import(fileTxId) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const file = yield createFileLike([fileData], name, type, (_a = fileMetadata === null || fileMetadata === void 0 ? void 0 : fileMetadata.block) === null || _a === void 0 ? void 0 : _a.timestamp);
            const tags = this.getFileTags(file);
            const { processedData, encryptionTags } = yield this.processWriteRaw(yield file.arrayBuffer());
            const resourceHash = yield (0, crypto_1.digestRaw)(processedData);
            tags.push(new contract_1.Tag(constants_1.fileTags.FILE_HASH, resourceHash));
    ...
    retrieveFileMetadata(fileTxId, tags = []) {
        var _a;
        const type = ((_a = (tags === null || tags === void 0 ? void 0 : tags.find((tag) => tag.name === "Content-Type"))) === null || _a === void 0 ? void 0 : _a.value)
            || "image/jpeg";
    ...
    getFileTags(file) {
        ...
        tags.push(new contract_1.Tag(constants_1.smartweaveTags.CONTENT_TYPE, this.contentType || file.type));
...
;
function createFileLike(sources, name, mimeType, lastModified) {
    return __awaiter(this, void 0, void 0, function* () {
        if (typeof window === "undefined") {
