 ...
 */
declare function encrypt(plaintext: Uint8Array, key: CryptoKey, encode?: boolean): Promise<string | any>;
/**
...
declare function deriveAddress(publicKey: any, prefix: string): Promise<string>;
/**
...
declare function decryptHybridString(encryptedPayload: any, privateKey: any): Promise<string>;
/**
...
declare const importRSAPublicKey: (publicKey: any) => Promise<CryptoKey>;
declare const importRSACryptoKey: (jwk: any) => Promise<CryptoKey>;
